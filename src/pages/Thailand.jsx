...
import banner from "../assets/images/International/country 3/thai slider.jpg";

import pkg1 from "../assets/images/International/country 3/thailand-package-for-5-nights-6-days-1400.jpeg";
  ...
  return (
    <div style={{ backgroundColor: "rgb(255, 244, 222)" }}>
      ...
      <div className="row mt-5 pt-4">
        <img src={banner} alt="Thailand" width="100%" />
      </div>

      {/* ================= CONTENT ================= */}
      <div className="container mt-5">
        <div className="text-center h2">
          <span className="text-warning">Thailand </span>
          <span className="text-primary">Tour </span>
          <span className="text-success">Packages</span>
        </div>

        <p>
          Thailand is famous for its pristine beaches, vibrant nightlife,
          ancient temples, and rich culture.
        </p>

        <p>
          From Bangkok to Phuket, Thailand tour packages offer unforgettable
          experiences filled with adventure and relaxation.
        </p>
      </div>
      ...
      <div className="container mt-4">
        ...
        <div className="row shadow-lg text-center mb-4">
          <div className="col-md-3 p-3">
            <img src={pkg1} alt="Thailand Package" width="100%" />
          </div>
          <div className="col-md-6 p-3">
            <h2 className="text-primary">Wondrous Thailand Tour</h2>
          ...
          <div className="col-md-3 p-3">
            <button className="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#thai1">
              View Detail
            </button>
          </div>
        </div>
        ...
        <div className="row shadow-lg text-center mb-4">
          <div className="col-md-3 p-3">
            <img src={pkg2} alt="Thailand Singapore" width="100%" />
          </div>
          <div className="col-md-6 p-3">
            <h2 className="text-primary">Thailand–Singapore Cruise Tour</h2>
          ...
          <div className="col-md-3 p-3">
            <button className="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#thai2">
              View Detail
            </button>
          </div>
        </div>
        ...
        <div className="row shadow-lg text-center mb-5">
          ...
          <div className="col-md-3 p-3">
            <button className="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#thai3">
              View Detail
            </button>
          </div>
        </div>

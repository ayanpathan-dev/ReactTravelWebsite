...
import banner from "../assets/images/International/singapore2.jpg";

import pkg1 from "../assets/images/International/country 2/singapore-and-cruise-1311.jpeg";
  ...
  return (
    <div style={{ backgroundColor: "rgb(255, 244, 222)" }}>
      ...
      <div className="row mt-5 pt-4">
        <img src={banner} alt="Singapore" width="100%" />
      </div>

      {/* ================= CONTENT ================= */}
      <div className="container mt-5">
        <div className="text-center h2">
          <span className="text-warning">Singapore </span>
          <span className="text-primary">Tour </span>
          <span className="text-success">Packages</span>
        </div>

        <p>
          Singapore is a vibrant city-state offering stunning skylines,
          world-class shopping, nightlife, beaches, and rich culture.
        </p>

        <p>
          From Universal Studios to Sentosa Island, Singapore promises an
      ...
      <div className="container mt-4">
        ...
        <div className="row shadow-lg text-center mb-4">
          <div className="col-md-3 p-3">
            <img src={pkg1} alt="Singapore Cruise" width="100%" />
          </div>
          <div className="col-md-6 p-3">
            <h2 className="text-primary">Singapore & Cruise Tour</h2>
            <span className="text-danger">Duration:</span> 6 Nights / 7 Days
            <p className="text-danger mt-2">
              Price – 150000 <del className="text-dark">220000</del> Rs/-
            </p>
          </div>
          <div className="col-md-3 p-3">
            <button className="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#singapore1">
              View Detail
            </button>
          </div>
        </div>
        ...
        <div className="row shadow-lg text-center mb-4">
          <div className="col-md-3 p-3">
            <img src={pkg2} alt="Singapore Malaysia Cruise" width="100%" />
          </div>
          <div className="col-md-6 p-3">
            <h2 className="text-primary">Singapore–Malaysia Cruise Tour</h2>
          ...
          <div className="col-md-3 p-3">
            <button className="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#singapore2">
              View Detail
            </button>
          </div>
        </div>
        ...
        <div className="row shadow-lg text-center mb-5">
          <div className="col-md-3 p-3">
            <img src={pkg3} alt="Thailand Singapore Malaysia" width="100%" />
          </div>
          <div className="col-md-6 p-3">
          ...
          <div className="col-md-3 p-3">
            <button className="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#singapore3">
              View Detail
            </button>
          </div>
        </div>
